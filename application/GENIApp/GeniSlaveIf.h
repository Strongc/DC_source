...
class GeniSlaveIf : public SubTask, public Observer
{
  public:
   ...
   // DDA methods
    ...
    void DDAAlarmReset(IO351_NO_TYPE moduleNo);
    bool GetDDAMaxPressure(IO351_NO_TYPE moduleNo, float* pValue);
    bool GetDDAMaxDosingCap(IO351_NO_TYPE moduleNo, float* pValue);
    ...
    bool GetDDAStopCtrState(IO351_NO_TYPE moduleNo, U8* pStatus);
    bool GetDDACtrSource(IO351_NO_TYPE moduleNo, U8* pStatus);
    bool GetDDAPumpingState(IO351_NO_TYPE moduleNo, bool* pStatus);
    ...
    void DDARequestStop(IO351_NO_TYPE moduleNo);
    void DDARequestStart(IO351_NO_TYPE moduleNo);
    void DDASetToUserMode(IO351_NO_TYPE moduleNo);
    void DDASetToManualDosing(IO351_NO_TYPE moduleNo);
    void DDASetToAnalogueDosing(IO351_NO_TYPE moduleNo);
    void DDASetToPulseDosing(IO351_NO_TYPE moduleNo);
    void DDAPressStartKey(IO351_NO_TYPE moduleNo);
    void DDAPressStopKey(IO351_NO_TYPE moduleNo);
