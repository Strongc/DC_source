...
namespace mpc
{
  namespace display
  {
    ...
    * DESCRIPTION:
    *
    * This Class is responsible for how to show a AlarmState string given by a DataPoint
    *
    *****************************************************************************/
    ...
    public:
      ...
      ********************************************************************/
      AlarmState(Component* pParent = NULL);
      /********************************************************************
      ...
      ********************************************************************/
      ...
      void GetStateDisplayNumber(int state, int pumpGroupSubmenu, char* displayNumber);
