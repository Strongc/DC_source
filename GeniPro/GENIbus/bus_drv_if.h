...
// Low level functions
//
EXTERN void TransmitBUSByte(UCHAR tx_byte);
/****************************************************************************
...
*---------------------------------------------------------------------------*/
EXTERN void ResetBUSDriver(void);
/****************************************************************************
*     Name      :  ResetBUSDriver                                           *
*     Inputs    :  none                                                     *
*     Outputs   :  none                                                     *
...
*               :  the next tgm.                                            *
*---------------------------------------------------------------------------*/
EXTERN void InitBUSDriver(UCHAR setup_param);
/****************************************************************************
*     Name      :  InitBUSDriver                                            *
*     Inputs    :  none                                                     *
*     Outputs   :  none                                                     *
...
*               :                                                           *
*---------------------------------------------------------------------------*/
EXTERN void DisableBUSDriver(void);
/****************************************************************************
...
*               :                                                           *
*---------------------------------------------------------------------------*/
EXTERN UCHAR TransmitSetupBUS(void);
/****************************************************************************
