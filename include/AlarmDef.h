...
typedef enum
{
  ...
  //ALARM_ID_TIME_FOR_SERVICE_IS_EXCEED                                    = 12,
  ALARM_ID_MAIN_SYSTEM_COMMUNICATION_FAULT                               = 15,
    ALARM_ID_16 = 16,
  ALARM_ID_OTHER                                                         = 16,
  ALARM_ID_CAPACITY_TOO_LOW                                              = 17,
  ALARM_ID_DIAPHRAGM_BREAK                                               = 19,
  ...
  ALARM_ID_MOTOR_PROTECTION_TRIPPED                                      = 27,
    ALARM_ID_30 = 30,
    ALARM_ID_32 = 32,
  ALARM_ID_SOON_TIME_FOR_SERVICE                                         = 33,
  ALARM_ID_GAS_IN_PUMP_HEAD                                              = 35,
  ALARM_ID_PRESSURE_VALVE_LEAKAGE                                        = 36,
  ALARM_ID_SUCTION_VALVE_LEAKAGE                                         = 37,
  ALARM_ID_VENTING_VALVE_DEFECT                                          = 38,
    ALARM_ID_40 = 40,
  ALARM_ID_CABLE_BREAKDOWN_ON_ANALOGUE                                   = 47,
    ALARM_ID_48 = 48,
  ALARM_ID_OVERLOAD                                                      = 48,
    ALARM_ID_49 = 49,
  ALARM_ID_PUMP_MOTOR_BLOCKED                                            = 51,
  //ALARM_ID_BLOCKED_MOTOR_OR_PUMP = 51,
    ALARM_ID_55 = 55,
  ...
  //ALARM_ID_CABLE_BREAKDOWN_ON_FLOW_MONITOR = 169,
  ...
  ALARM_ID_PRE_EMPTY_TANK                                                = 206,
  ALARM_ID_CAVITATIONS                                                   = 208,
  ALARM_ID_OVER_PRESSURE                                                 = 210,
  ALARM_ID_MEAN_PRESSURE_TO_LOW                                          = 211,
